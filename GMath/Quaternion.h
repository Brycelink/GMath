...
namespace GMath{
    ...
    public:
        ...
        QuaternionType<_T>& Multiply(const VectorType<GMATH_TYPE_PRECISION, 3>& vec)
        {
        ...
        friend QuaternionType<_T> operator*(QuaternionType left, const VectorType<GMATH_TYPE_PRECISION, 3>& right)
        {
